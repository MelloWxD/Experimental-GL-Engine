...
#include<filesystem>
Texture::Texture(const char* img_path, GLenum texture_type, GLuint slot, GLenum format, GLenum pixelType)
{
	...
	glTexImage2D(texture_type, 0, GL_RGBA, widthImg, heightImg, 0, format, pixelType, bytes);
	// Generates MipMaps
